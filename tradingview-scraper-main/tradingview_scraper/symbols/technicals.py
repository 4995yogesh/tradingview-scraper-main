...
class Indicators:
    ...
    def _load_indicators(self) -> List[str]:
        ...
        """
        path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data', 'indicators.txt')
    ...
    def _load_timeframes(self) -> dict:
        ...
        """
        path = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'data', 'timeframes.json')
